...
func TestRecentPodEventMessages_ReturnsMessages(t *testing.T) {
	clientset := fake.NewSimpleClientset(
		&corev1.Event{
			ObjectMeta: metav1.ObjectMeta{Name: "medispan-dur-engine.startup", Namespace: "prod"},
			InvolvedObject: corev1.ObjectReference{
				Kind: "Pod", Name: "medispan-dur-engine-abc123", Namespace: "prod",
			},
			Type:    "Warning",
			Reason:  "Unhealthy",
		...
		&corev1.Event{
			ObjectMeta: metav1.ObjectMeta{Name: "medispan-dur-engine.killing", Namespace: "prod"},
			InvolvedObject: corev1.ObjectReference{
				Kind: "Pod", Name: "medispan-dur-engine-abc123", Namespace: "prod",
			},
			Type:    "Normal",
	...
	messages, err := recentPodEventMessages(clientset, "prod", "medispan-dur-engine-abc123")
	if err != nil {
